...
export const sendMessageToGemini = async (
  ...
  try {
    ...
    const chat = ai.chats.create({
      ...
      config: {
        systemInstruction: `Eres ConecTATE, la asistente virtual premium de RinconIQQ. Tu misión es actuar como una "Event Planner" experta y completa para la región de Tarapacá.

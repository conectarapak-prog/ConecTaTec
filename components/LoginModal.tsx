...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onSwitchToSignUp }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden flex animate-fade-in h-auto max-h-[90vh]">
        ...
        <div className="hidden md:flex w-2/5 bg-gray-900 relative flex-col justify-between p-8 text-white">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300">
              Gestiona tus eventos, revisa tus reservas y descubre nuevos espacios exclusivos en Tarapacá.
            </p>
          </div>
             ...
             <div className="p-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/10">
                <div className="flex items-center gap-3 mb-2">
                   <div className="flex -space-x-2">
                      <div className="w-8 h-8 rounded-full border-2 border-gray-800 bg-gray-300"></div>
                      <div className="w-8 h-8 rounded-full border-2 border-gray-800 bg-gray-400"></div>
                      <div className="w-8 h-8 rounded-full border-2 border-gray-800 bg-gray-500"></div>
                   </div>
        ...
        <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-xs text-primary font-medium hover:underline">¿Olvidaste tu contraseña?</a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            ¿Aún no tienes cuenta? <button type="button" onClick={onSwitchToSignUp} className="text-primary font-bold hover:underline">Regístrate Gratis</button>
          </p>
        </div>
      </div>
    </div>
